          ...
          <t-dropdown :min-column-width="120" trigger="click">
            <template #dropdown>
              <t-dropdown-menu>
                ...
                <t-dropdown-item class="operations-dropdown-container-item" @click="handleLock()">
                  <t-icon name="lock-on"></t-icon>锁定屏幕
                </t-dropdown-item>
...
<!--                <t-icon class="header-user-avatar" name="user-circle" />-->
    ...
    <lock-dialog v-model:visible="formDialogVisible"></lock-dialog>
  </div>
</template>
...
import LockDialog from '@/components/lockDialog/index.vue';
